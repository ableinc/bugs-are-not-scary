        ...
        <article class="bug-detail" style={{ '--bug-color': b().color }}>
          ...
          <div class="bug-detail-hero">
            ...
            <div class="bug-detail-intro">
              ...
              <ReadAloudButton bugId={b().id} audioType="full" />
            </div>
          </div>
          ...
          <div class="bug-detail-sections">
            <section class="bug-section">
              <h2>🔍 About Me</h2>
              <p>{b().description}</p>
              <ReadAloudButton bugId={b().id} audioType="description" />
            </section>

            <section class="bug-section">
              <h2>🏡 Where I Live</h2>
              <p>{b().habitat}</p>
              <ReadAloudButton bugId={b().id} audioType="habitat" />
            </section>

            <section class="bug-section">
              <h2>🍽️ What I Eat</h2>
              <p>{b().diet}</p>
              <ReadAloudButton bugId={b().id} audioType="diet" />
            </section>
            ...
            <Show when={b().useCaution}>
              <section class="bug-section">
                <h2>⚠️ Safety</h2>
                <p>{b().safety}</p>
                <ReadAloudButton bugId={b().id} audioType="safety" />
              </section>
            </Show>
